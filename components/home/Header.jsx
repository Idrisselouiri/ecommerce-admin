            ...
            <div className="flex items-center gap-2">
              {session ? (
                <div className="relative">
                  ...
                  />
                  {toggleDropdown && (
                    <div className="absolute right-0 top-full mt-5 w-full p-4 rounded-lg bg-white min-w-[180px] flex flex-col gap-2 justify-end items-end shadow-lg	">
                      <div className="">
                      ...
                      >
                        <span className="text-sm font-inter text-gray-700 hover:text-gray-500 font-medium">
                          Profile
                        </span>
                      </Link>
                      <div>
                ...
                <Link href={"/signin"}>
                  <button
                    type="button"
                    className="py-2 px-5 text-white font-medium bg-emerald-500 rounded-lg"
                  >
                    Sign in
                  </button>
                </Link>
